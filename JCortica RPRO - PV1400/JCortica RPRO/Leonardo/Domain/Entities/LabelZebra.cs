...
namespace TesteImpresao.Entities
{
    public class LabelZebra : ILabel
    {
        ...
        public LabelZebra CreateNewLineProductTable(LabelItem labelItem, int index)
        {
            ...
            string line = $@"
                            ^FO66,{startBorderY + (index * 30)}^GB320,32,2^FS
                            ^FO384,{startBorderY + (index * 30)}^GB224,32,2^FS
                            ^FO607,{startBorderY + (index * 30)}^GB190,32,2^FS
                            ^FT78,{startTextY + (index * 30)}^A0N,17,18^FH\^CI28^FD{labelItem.ProductName}^FS^CI27
                            ^FT458,${startTextY + (index * 30)}^A0N,17,18^FH\^CI28^FD{labelItem.Lote}^FS^CI27         
                            ^FT688,${startTextY + (index * 30)}^A0N,17,18^FH\^CI28^FD{labelItem.Weight}^FS^CI27";
